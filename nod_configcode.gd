...
var CONFIGDATA_use_debug_controls        : bool = true    ## FOR_DEBUG_ONLY ##
var CONFIGDATA_god_mode_cant_touch_this  : bool = true    ## FOR_DEBUG_ONLY ##
var CONFIGDATA_maximum_goose_override    : bool = false   ## FOR_DEBUG_ONLY ##
var CONFIGDATA_start_with_3_seconds_left : bool = false   ## FOR_DEBUG_ONLY ##


var CONFIGDATA_game_duration_in_minutes : float = 0.5
...
var CONFIGDATA_fall_speed_in_pixels_per_frame_at_60fps : int = ( 11 )
var CONFIGDATA_get_those_turd_clouds_out_of_my_sight : bool = true
var CONFIGDATA_explosions_rotate_while_exploding     : bool = true

var CONFIGDATA_fall_into_hay_speed      :  int =( 
	CONFIGDATA_fall_speed_in_pixels_per_frame_at_60fps 
)   ## PER_FRAME      ##
